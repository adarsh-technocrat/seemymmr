...
export function IntegrationsSettings({
  ...
  const handleConnectGoogleSearchConsole = () => {
    // TODO: Implement Google Search Console OAuth flow
    window.location.href = `/api/websites/${websiteId}/integrations/google-search-console/connect`;
  };
    ...
    <div className="space-y-6">
      ...
      <Card className="custom-card bg-base-100">
        <div className="custom-card-head flex items-center justify-between gap-4">
          <div>
            ...
            >
              <g clipPath="url(#a)">
                <path
                  d="M11.081 30.527l-4.72 4.721a.933.933 0 0 1-1.317 0l-.292-.292a.933.933 0 0 1 0-1.316l4.72-4.721a.933.933 0 0 1 1.318 0l.291.291a.93.93 0 0 1 0 1.317z"
                  fill="#FBBC04"
                />
                <path
                  d="M23.75 32.5h6.042a6.04 6.04 0 0 0 6.041-6.042v-16.25a6.04 6.04 0 0 0-6.041-6.041 6.04 6.04 0 0 0-6.042 6.041V32.5z"
                  fill="#4285F4"
                />
                <path
                  d="M13.75 32.5a6.04 6.04 0 0 0 6.042-6.042 6.04 6.04 0 0 0-6.042-6.041 6.04 6.04 0 0 0-6.042 6.041A6.04 6.04 0 0 0 13.75 32.5z"
                  fill="#FBBC04"
                />
                <path
        ...
        <div className="space-y-4 p-4">
          <div className="text-base-secondary text-sm">
            Discover what Google search terms drive traffic to your website.
            With revenue attribution enabled, estimate revenue from these search
            terms. Read more about{" "}
            <Link
      ...
      <Card className="custom-card bg-base-100">
        <div className="min-h-[400px]">
          <div className="flex h-full flex-col items-center overflow-y-scroll p-4 text-center">
            <div className="mb-8 w-full rounded-[1.3rem] border border-base-content/5 bg-neutral/5 p-1.5 dark:bg-neutral/50">
              <div className="w-full overflow-hidden rounded-box">
                <div className="aspect-video scale-[1.06] bg-base-300">
                  {/* Video player placeholder - you can replace with actual mux-player if needed */}
            ...
            <div className="mb-6">
              <h3 className="mb-4 flex items-center justify-center gap-2 text-lg font-semibold text-base-content">
                Find who talks about you on{" "}
                <div className="flex size-6 items-center justify-center rounded bg-black drop-shadow-sm">
                  <svg
              ...
              <p className="text-base-secondary px-4 text-sm">
                Track mentions of your brand and keywords on 𝕏 (Twitter) to
                connect social buzz to revenue and traffic spikes.
              </p>
            </div>
            ...
            <p className="text-base-secondary mt-3 text-xs opacity-75">
              Includes{" "}
              <Link
      ...
      <Card className="custom-card bg-base-100">
        ...
        <CardContent className="space-y-4 p-4">
          <p className="text-base-secondary text-sm">
            Install the GitHub App to see your latest commits on your analytics
            chart and find what moves the needle!
          </p>
          <div className="space-y-2">
            <Button
              size="sm"
            ...
            <p className="text-base-secondary text-center text-xs opacity-80">
              We only need read-only access to your repositories
            </p>
          </div>
        </CardContent>
      </Card>
