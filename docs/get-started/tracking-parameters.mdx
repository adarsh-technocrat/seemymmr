...
UTM parameters are automatically captured by seeMoreThanMMR. Add them to your URLs:
...
seeMoreThanMMR automatically tracks referrers. When a user clicks a link to your site, the referrer is captured.
