...
seeMoreThanMMR supports the following payment providers:
...
When a payment is completed, seeMoreThanMMR links it to the visitor who made the purchase. This allows you to:
...
Webhooks automatically send payment data to seeMoreThanMMR when a payment is completed.
...
seeMoreThanMMR uses three methods to link payments to visitors, in order of preference:
