...
seeMoreThanMMR is the best web analytics tool to discover which marketing channels drive revenue and grow your business, fast.

## Get started

Get started in 4 stepsGrow your business with seeMoreThanMMR in 4 stepsConnect payment providersConnect your payment providerUse tracking parametersGet better analytics with URL tracking parametersFilter your dataUsing seeMoreThanMMR filters to analyze your dataTrack custom goalsTrack custom user actions (Goals)Track conversion funnelsTrack conversion funnelsConnect Google Search ConsoleConnect Google Search Console with seeMoreThanMMR
...
<CardGroup cols={2}>
  ...
  <Card title="Filter your data" icon="filter" href="/get-started/filter-data">
    Use seeMoreThanMMR filters to analyze your data by date, source, location,
    and more.
  </Card>
  <Card
  ...
  >
    Connect Google Search Console with seeMoreThanMMR to see search performance.
  </Card>
</CardGroup>

## Installation guides

Add seeMoreThanMMR to your website in minutes. Choose your platform below.

<CardGroup cols={3}>
  <Card title="Next.js" icon="nextjs" href="/installation/nextjs">
    Add seeMoreThanMMR to your Next.js App Router project
  </Card>
  <Card title="React" icon="react" href="/installation/react">
    Add seeMoreThanMMR to your React application
  </Card>
  <Card title="Vue.js" icon="vue" href="/installation/vue">
    Add seeMoreThanMMR to your Vue.js project
  </Card>
  <Card title="WordPress" icon="wordpress" href="/installation/wordpress">
    Add seeMoreThanMMR to your WordPress site
  </Card>
  <Card title="Shopify" icon="shopify" href="/installation/shopify">
    Add seeMoreThanMMR to your Shopify store
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Proxy setup" icon="shield" href="/proxy/get-started">
    Proxy seeMoreThanMMR through your domain for privacy
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Get started" icon="code" href="/api-reference/introduction">
    Learn how to use the seeMoreThanMMR API
  </Card>
