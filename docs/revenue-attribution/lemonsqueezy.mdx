...
Subscription events are tracked separately. When a subscription is created or updated, it's recorded in seeMoreThanMMR. You can track recurring revenue separately from one-time payments.
